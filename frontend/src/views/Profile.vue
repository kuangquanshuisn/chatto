    ...
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6">
      ...
      <div class="space-y-6">
        ...
        <div class="flex justify-center gap-4 mt-6">
          <button
            @click="$router.back()"
            class="px-6 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors duration-200"
          >
            返回上页
          </button>
          <button
